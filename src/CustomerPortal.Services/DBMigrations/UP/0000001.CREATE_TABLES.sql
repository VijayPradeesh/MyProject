/****** Object:  Table [dbo].[Comment_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[ContractRegionMapping_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[DFRStatusTracking_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[ErrorLogging_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[JobEquipment_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[JobLabor_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[JobMaster_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[JobRevenue_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Lookup_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[SchemaVersions]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[TypeRoleMapping_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[User_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[UserPasswordHistory_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[UserRoleRegionMapping_T]    Script Date: 06-12-2022 18:25:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_JobMaster_T_IsLockDown]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[JobMaster_T] ADD  CONSTRAINT [DF_JobMaster_T_IsLockDown]  DEFAULT ((0)) FOR [IsLockDown]
END
GO
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__TypeRoleM__Added__6FB49575]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[TypeRoleMapping_T] ADD  DEFAULT (getdate()) FOR [AddedDate]
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__TypeRoleM__ACTIV__70A8B9AE]') AND type = 'D')
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_User_T_ForgotPassword]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[User_T] ADD  CONSTRAINT [DF_User_T_ForgotPassword]  DEFAULT ((0)) FOR [ForgotPassword]
END
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Comment_T_Lookup_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[Comment_T]'))
ALTER TABLE [dbo].[Comment_T]  WITH CHECK ADD  CONSTRAINT [FK_Comment_T_Lookup_T] FOREIGN KEY([CommentTypeID])
REFERENCES [dbo].[Lookup_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Comment_T_Lookup_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[Comment_T]'))
ALTER TABLE [dbo].[Comment_T] CHECK CONSTRAINT [FK_Comment_T_Lookup_T]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_CP_USER_T_CPUserID]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T]  WITH CHECK ADD  CONSTRAINT [FK_DFRStatusTracking_CP_USER_T_CPUserID] FOREIGN KEY([CPUserID])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_CP_USER_T_CPUserID]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T] CHECK CONSTRAINT [FK_DFRStatusTracking_CP_USER_T_CPUserID]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_JobMaster_T_JobMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T]  WITH CHECK ADD  CONSTRAINT [FK_DFRStatusTracking_T_JobMaster_T_JobMaster] FOREIGN KEY([JobMasterID])
REFERENCES [dbo].[JobMaster_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_JobMaster_T_JobMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T] CHECK CONSTRAINT [FK_DFRStatusTracking_T_JobMaster_T_JobMaster]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_Lookup_ReasonType]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T]  WITH CHECK ADD  CONSTRAINT [FK_DFRStatusTracking_T_Lookup_ReasonType] FOREIGN KEY([ReasonTypeID])
REFERENCES [dbo].[Lookup_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_Lookup_ReasonType]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T] CHECK CONSTRAINT [FK_DFRStatusTracking_T_Lookup_ReasonType]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_Lookup_T_StatusType]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T]  WITH CHECK ADD  CONSTRAINT [FK_DFRStatusTracking_T_Lookup_T_StatusType] FOREIGN KEY([StatusID])
REFERENCES [dbo].[Lookup_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DFRStatusTracking_T_Lookup_T_StatusType]') AND parent_object_id = OBJECT_ID(N'[dbo].[DFRStatusTracking_T]'))
ALTER TABLE [dbo].[DFRStatusTracking_T] CHECK CONSTRAINT [FK_DFRStatusTracking_T_Lookup_T_StatusType]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Lookup_T_User_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[Lookup_T]'))
ALTER TABLE [dbo].[Lookup_T]  WITH CHECK ADD  CONSTRAINT [FK_Lookup_T_User_T] FOREIGN KEY([AddedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Lookup_T_User_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[Lookup_T]'))
ALTER TABLE [dbo].[Lookup_T] CHECK CONSTRAINT [FK_Lookup_T_User_T]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Lookup_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[Lookup_T]'))
ALTER TABLE [dbo].[Lookup_T]  WITH CHECK ADD  CONSTRAINT [FK_Lookup_T_User_T1] FOREIGN KEY([ChangedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Lookup_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[Lookup_T]'))
ALTER TABLE [dbo].[Lookup_T] CHECK CONSTRAINT [FK_Lookup_T_User_T1]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_User_T_User_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[User_T]'))
ALTER TABLE [dbo].[User_T]  WITH CHECK ADD  CONSTRAINT [FK_User_T_User_T] FOREIGN KEY([AddedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_User_T_User_T]') AND parent_object_id = OBJECT_ID(N'[dbo].[User_T]'))
ALTER TABLE [dbo].[User_T] CHECK CONSTRAINT [FK_User_T_User_T]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_User_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[User_T]'))
ALTER TABLE [dbo].[User_T]  WITH CHECK ADD  CONSTRAINT [FK_User_T_User_T1] FOREIGN KEY([ChangedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_User_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[User_T]'))
ALTER TABLE [dbo].[User_T] CHECK CONSTRAINT [FK_User_T_User_T1]
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserPasswordHistory_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserPasswordHistory_T]'))
ALTER TABLE [dbo].[UserPasswordHistory_T]  WITH CHECK ADD  CONSTRAINT [FK_UserPasswordHistory_T_User_T1] FOREIGN KEY([AddedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserPasswordHistory_T_User_T1]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserPasswordHistory_T]'))
ALTER TABLE [dbo].[UserPasswordHistory_T] CHECK CONSTRAINT [FK_UserPasswordHistory_T_User_T1]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserPasswordHistory_T_User_T2]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserPasswordHistory_T]'))
ALTER TABLE [dbo].[UserPasswordHistory_T]  WITH CHECK ADD  CONSTRAINT [FK_UserPasswordHistory_T_User_T2] FOREIGN KEY([ChangedBy])
REFERENCES [dbo].[User_T] ([ID])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserPasswordHistory_T_User_T2]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserPasswordHistory_T]'))
ALTER TABLE [dbo].[UserPasswordHistory_T] CHECK CONSTRAINT [FK_UserPasswordHistory_T_User_T2]
GO
