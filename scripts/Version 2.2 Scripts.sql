...
--------> Inserting Data into Look up table related to Sewer Camera 
BEGIN 
...
---------------> Creating Tables related to Sewer Camera

/****** Object:  Table [dbo].[SewerCam_T]    Script Date: 08-05-2023 15:51:32 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[SewerCamDetails_T]    Script Date: 08-05-2023 15:51:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__SewerCamD__Sewer__4C364F0E]') AND parent_object_id = OBJECT_ID(N'[dbo].[SewerCamDetails_T]'))
